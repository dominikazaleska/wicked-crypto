...
const WarsawUpcomingList = () => (
  <div className="meetups">
      <div>
      <a className="mdl-button mdl-js-button button-city" href="/meetups/warsawpast">
          PAST
      </a>
      <a className="mdl-button mdl-js-button button-city" href="/meetups/warsawupcoming">
          UPCOMING
      </a>
      </div>
      <div className="meetups-info">
        <h1 className="meetups-place">Meetups</h1>
        <h3>UPCOMING {MeetupsAPI.warsawnumber()} EVENTS</h3>
      </div>
    <ul className="meetups-small">
      {
        MeetupsAPI.warsawupcoming().map(m => (
...
export default WarsawUpcomingList;