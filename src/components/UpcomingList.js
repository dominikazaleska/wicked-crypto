...
const UpcomingList = () => (
  <div className="meetups">
      <div>
      <a className="mdl-button mdl-js-button button-city" href="/meetups/past">
          PAST
      </a>
      <a className="mdl-button mdl-js-button button-city" href="/meetups/upcoming">
          UPCOMING
      </a>
      </div>
      <div className="meetups-info">
        <h1 className="meetups-place">Meetups</h1>
        <h3>UPCOMING {MeetupsAPI.number()} EVENTS</h3>
      </div>
    <ul className="meetups-small">
      {
        MeetupsAPI.upcoming().map(m => (
