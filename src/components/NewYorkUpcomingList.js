...
const NewYorkUpcomingList = () => (
  <div className="meetups">
      <div>
      <a className="mdl-button mdl-js-button button-city" href="/meetups/newyorkpast">
          PAST
      </a>
      <a className="mdl-button mdl-js-button button-city" href="/meetups/newyorkupcoming">
          UPCOMING
      </a>
      </div>
      <div className="meetups-info">
        <h1 className="meetups-place">Meetups</h1>
        <h3>UPCOMING {MeetupsAPI.newyorknumber()} EVENTS</h3>
      </div>
    <ul className="meetups-small">
      {
        MeetupsAPI.newyorkupcoming().map(m => (
...
export default NewYorkUpcomingList;